...
## [0.2.1](https://github.com/Dreyzab/grenzwanderer/compare/app-v0.2.0...app-v0.2.1) (2026-06-30)


### Features

* add dm_turn logging to SpacetimeDB and update visual novel content ([d207d20](https://github.com/Dreyzab/grenzwanderer/commit/d207d203c7dcf4cff92d50143b031c749fe36507))
...
* Case01 warehouse finale, character sprites, bureau explorer, and VN quality ratings ([28fdfc3](https://github.com/Dreyzab/grenzwanderer/commit/28fdfc379fd299e0c2c43c2b2a772c05f597d59b))
* **case01:** integrate Victoria Sterling assets and Rathaus Summit CG illustration ([00e5b29](https://github.com/Dreyzab/grenzwanderer/commit/00e5b29050f2a79a90fe5574c04023f0beca9c1f))
* **case01:** witch tabletop DM, map journey UI, and letter choices ([cb1aa6c](https://github.com/Dreyzab/grenzwanderer/commit/cb1aa6c35f0391fece0ec4f541b151c740dea928))
...
* **i18n:** finalize localization hardening and fix verification pipeline ([3d2b3f7](https://github.com/Dreyzab/grenzwanderer/commit/3d2b3f78c896e099e468e7ea700fbdb5fb30c74b))
...
* migrate Eleonora parliament and implement feedback analysis system ([a9cdd63](https://github.com/Dreyzab/grenzwanderer/commit/a9cdd63b5f0b91b249f87223d3bd296ec3b3ad02))
...
* **parliament:** Eleonora migration, map refactor, and VN choice visibility ([f0b8a00](https://github.com/Dreyzab/grenzwanderer/commit/f0b8a00922108343b04359fd2eb42fc6b0c9ff67))
...
* update visual novel scenes, assets, docs, and spacetime reducers ([6ee8b76](https://github.com/Dreyzab/grenzwanderer/commit/6ee8b765954a260c88eb37dd3e394a44e54d7977))
* update VN UI, optimize prefetching, and integrate Case 01 Dining Car assets ([6a40212](https://github.com/Dreyzab/grenzwanderer/commit/6a40212fd198c58cc814f2d8c593c46c8f18aca9))
...
* **vn:** «Обдумать» — in-log inner-voice reflection with real AI ([29a8bd4](https://github.com/Dreyzab/grenzwanderer/commit/29a8bd4bddba4c744ecd3292278a24ea49e2820a))
...
* **vn:** visual sequences, parliament modules, and witch memory prologue assets ([be3452d](https://github.com/Dreyzab/grenzwanderer/commit/be3452da054aa7fa343c5e87a7b6395570fc1202))
* witch train prologue, character bridge, equipment, and VN hub ([1dc5bb2](https://github.com/Dreyzab/grenzwanderer/commit/1dc5bb2b97c8b1a30c6a5929a6834419b4ff5387))
* **witch:** volition tokens, ritual relief, Warm Veto branch, and parliament docs ([606d38f](https://github.com/Dreyzab/grenzwanderer/commit/606d38ffe850969ab0578b942c37d5370cd3f605))
...
* align dev dependency update with build ([41f3d92](https://github.com/Dreyzab/grenzwanderer/commit/41f3d929060e36c172b007c042d8fba4bf1f4696))
* avoid restarting inner parliament scenario ([fafb74f](https://github.com/Dreyzab/grenzwanderer/commit/fafb74f599a69e91bdc35522b787bfe624adc299))
...
* **content:** register Warm Veto flag and volition token in player vocabulary ([a9ea7a1](https://github.com/Dreyzab/grenzwanderer/commit/a9ea7a1a47695fb3b07dba2ed6337bae50e0d71c))
...
* enter inner parliament smoke through origin ([6798f2b](https://github.com/Dreyzab/grenzwanderer/commit/6798f2b2fb917ba5e75ea975b6b34cf45859a4ad))
...
* patch mapbox point geometry type stub ([73a0f60](https://github.com/Dreyzab/grenzwanderer/commit/73a0f608d7b702c4a3e01bfe0c1bef7dfeff38f9))
* recover SpacetimeDB deploy connection ([aafff29](https://github.com/Dreyzab/grenzwanderer/commit/aafff29a68b1d82fd18ba077ebb5af476e6f8876))
* register flag_witch_knows_bureau_holds_sasha and dm_turn in matrix ([153093c](https://github.com/Dreyzab/grenzwanderer/commit/153093c8b8ea9ef8851d6845b28df93a7606e3c8))
* register witch_hotel_checked_in in player flag canon ([68d8fd7](https://github.com/Dreyzab/grenzwanderer/commit/68d8fd7aa7e881cb6fbdf8121ca1b0a68684a683))
...
* **spacetimedb:** narrow case catalog cache before read ([7846ac9](https://github.com/Dreyzab/grenzwanderer/commit/7846ac9dd629387dc867e83ebb6b20f704c8b62b))
* **spacetimedb:** reorder table columns and add defaults to satisfy maincloud migration requirements ([5b833c1](https://github.com/Dreyzab/grenzwanderer/commit/5b833c1645ab537af221a6ec699de52826750a97))
...
* stabilize mapbox point geometry types ([0a98933](https://github.com/Dreyzab/grenzwanderer/commit/0a9893314ff10ea58dfb0e4adb89583c87c32c97))
* **test:** align case catalog and VnScreen tests with snapshot schema and collapsed DM panel ([4da5a47](https://github.com/Dreyzab/grenzwanderer/commit/4da5a470b83026981e4344146bbca1ac222af86e))
* **test:** stabilize vitest pre-push and VnScreen suite ([e516ab6](https://github.com/Dreyzab/grenzwanderer/commit/e516ab6a10b3b6c8fb8689cbf57b86d51364a0d3))
* tolerate migrated SpacetimeDB index names ([951c4f2](https://github.com/Dreyzab/grenzwanderer/commit/951c4f26b40f98f391d3ceeba9df65645af3cad2))
...
* **vn-contract:** relax strict vocabulary validation and improve diagnostics ([b62225d](https://github.com/Dreyzab/grenzwanderer/commit/b62225d7805428ce11298ef11897e585023cbc3a))
* **vn-contract:** remove unused variables in vocabulary.ts ([75f4b4e](https://github.com/Dreyzab/grenzwanderer/commit/75f4b4eaad999777531e7c4b9913358295c32e48))
...
* align acceptance smoke pipeline ([d5e6078](https://github.com/Dreyzab/grenzwanderer/commit/d5e607811d990a96d3523aed6ec1cbe07e2ad7bd))
* align case01 map and journal UI expectations with canon runtime ([e39be4a](https://github.com/Dreyzab/grenzwanderer/commit/e39be4ae60aeb00aa3fb6def8c8b47c39d5ab053))
* align inner parliament gating error ([b59bc17](https://github.com/Dreyzab/grenzwanderer/commit/b59bc17c4a7d2e0988e2c48ca60e623b4d08c5d3))
...
* align eslint rules with dev deps ([b3cbc34](https://github.com/Dreyzab/grenzwanderer/commit/b3cbc344a67a9f0f16114b3f8167dc45047b111f))
* ignore generated vn snapshots in prettier ([3522248](https://github.com/Dreyzab/grenzwanderer/commit/352224827ea182a39501228be9c13199a228c2b3))
...
* bump the dev-deps group with 18 updates ([966f5c2](https://github.com/Dreyzab/grenzwanderer/commit/966f5c2adefd5e9f827bc7abc7c8053dd361678a))
* **ci:** update release-please-action to v5.0.0 ([6755e0e](https://github.com/Dreyzab/grenzwanderer/commit/6755e0e16af378a45457078a5608df122be2fcd1))
* commit generated vn snapshots ([7556a58](https://github.com/Dreyzab/grenzwanderer/commit/7556a58017c404ea25dad190944f5ff683f64862))
...
* ignore log files, format docs, and commit operator panel entrypoint ([91b0f18](https://github.com/Dreyzab/grenzwanderer/commit/91b0f1837f5b82c62ebfedc8f4fb9f1ba63381f6))
...
* refresh generated vn snapshots ([56d9891](https://github.com/Dreyzab/grenzwanderer/commit/56d9891bc9bd5191f7d862b013aacc7a3757c712))
* refresh vn snapshots ([4230888](https://github.com/Dreyzab/grenzwanderer/commit/423088850e3025e38480045ac7c87b33580c387f))
...
* **test:** raise vitest Node heap for pre-push stability ([2a3eac7](https://github.com/Dreyzab/grenzwanderer/commit/2a3eac74a58fb14a2248b9d603ea006bae04b6f8))
* update build artifacts and character ledger ([7a15564](https://github.com/Dreyzab/grenzwanderer/commit/7a15564cb8a12c3633df2c561e7139f6ffff353f))
* update bun lockfile for dev deps ([bd6e2ef](https://github.com/Dreyzab/grenzwanderer/commit/bd6e2ef5b540c8b11288ffa58ec93fc50157b371))
...
* update project workflows and runtime checks ([aa17eaa](https://github.com/Dreyzab/grenzwanderer/commit/aa17eaa10cf9ea8a5852d8a386f4942cdf329d91))
