...
export const questCatalog: QuestMeta[] = [
  ...
  { id: 'field_medicine', phase: 1, startPointKey: 'synthesis_medical_center', startStep: 'medical_emergency' as QuestStep },
  { id: 'combat_baptism', phase: 1, startPointKey: 'fjr_office_start', startStep: 'combat_available_on_board' as QuestStep },
  { id: 'quiet_cove_whisper', phase: 1, startPointKey: 'city_gate_travers', startStep: 'courier_missing' as QuestStep },
