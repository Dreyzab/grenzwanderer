import { useSaveSystem } from '@/entities/visual-novel/model/hooks'
...
export function GameUI() {
  ...
  return (
    <div className="absolute top-4 right-4 flex gap-2">
      ...
      <button className="bg-emerald-700 hover:bg-emerald-600 text-white rounded px-3 py-1" onClick={next}>
        Дальше
      </button>
    </div>
  )
