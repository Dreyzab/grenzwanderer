...
export function Component() {
  ...
  const call = async (key: 'map_points' | 'bindings' | 'registry' | 'init') => {
    try {
      setBusy(key)
      let didSeed = false
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button disabled={busy !== null} className="px-3 py-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700 disabled:opacity-50" onClick={() => call('registry')}>Seed Quest Registry</button>
