...
| -------- | ------------------------------------------------ | --------- |
| Logic    | "He maps contradictions before emotions settle." | 8         |
| Volition | "He hardens when institutional pressure peaks."  | 7         |
| Empathy  | "He recognizes fear but treats it as evidence."  | 6         |

## Secrets

- **Surface**: Hired to solve the bank case quickly and quietly.
- **Hidden**: Carries unresolved guilt from a prior failed investigation.
- **Core**: Only Volition can surface that he is susceptible to blackmail via old Berlin files.
...
- **Stage 1** (start): Procedural and distant; prioritizes control over trust.
- **Stage 2** (after clue unlock): After bank contradiction evidence, shifts to targeted risks.
- **Stage 3** (finale): Chooses either public truth route or controlled institutional settlement.

## Scenes & Quests

- Appears in: [[10_Narrative/Scenes/node_intro_char_creation|node_intro_char_creation]]
