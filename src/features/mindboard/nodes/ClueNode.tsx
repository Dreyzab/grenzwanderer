...
export function ClueNode({
    ...
    return (
        <div
            className={`relative bg-[#e6e2d3] border-2 border-[#cec9b6] p-4 w-48 flex flex-col items-center justify-center transition-all ${data.isPlaced ? "shadow-xl" : "shadow-md opacity-80"
                }`}
            style={{
